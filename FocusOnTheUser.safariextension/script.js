...
link.rel = 'stylesheet';
link.type = 'text/css';
link.href = 'http://focusontheuser.org/dontbeevil/style.css?3';
anchor.parentNode.insertBefore(link, anchor);

var script = document.createElement('script');
script.src = 'http://ajax.googleapis.com/ajax/libs/mootools/1.4.1/mootools-yui-compressed.js';
script.onload = main;
...
var getSearchResult = (function() {
  ...
  var findMeaningfulResults = function(text, results) {
    ...
    return results.filter(function(result) {
      ...
      // MMake sure we haven't already found a higher ranked site match.
      var site = matches[1];
...
var siteMap = {
  ...
  'flickr.com': {
    name: 'Flickr',
    whitelist: /(?:^|[\/.])flicker\.com\/people\/(\w+)\/?$/i
  },
  'foursquare.com': {
    name: 'Foursquare',
